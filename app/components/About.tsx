export default function About() {
  return (
    <section
      id="about"
      className="w-full max-w-[1520px] flex gap-12 mx-auto px-4 py-20"
    >
      <div className="">
        <span className="flex min-w-[100px] justify-center bg-white px-6 py-5 rounded-3xl text-center font-semibold mt-2">
          О нас
        </span>
      </div>
