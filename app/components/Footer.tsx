import { BossImg, Logo, TgLogo } from "../constants";
    ...
    <footer className="bg-[#181a1c] rounded-t-[40px] md:rounded-t-[70px] mt-10 md:mt-20 py-8 md:py-16">
      <div className="w-full max-w-[1520px] mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          {/* Column 4 */}
          <div className="border-t md:border-t-0 md:border-l border-[#404549] pt-6 md:pt-0 md:pl-6 lg:pl-12">
            <div className="flex items-center justify-between bg-[#404549] rounded-2xl md:rounded-3xl p-4 md:p-6 mb-4 md:mb-6 md:max-w-[465px]">
              <div>
            ...
            <div className="flex flex-col md:flex-row gap-4 bg-[#404549] rounded-2xl md:rounded-3xl md:max-w-[465px]">
              ...
              <a
                ...
                className="block w-full md:w-[195px] rounded-xl md:rounded-2xl overflow-hidden hover:opacity-90 transition-opacity"
              >
                <img
